class SharesController < ApplicationController
  ...
  def destroy
    ...
    redirect_to @password, notice: 'User removed from password share!'
  end
  ...
  def require_shareable_permission
    redirect_to @password, notice: "You don't have permission to do this!" unless current_user_password.shareable?
  end
end
